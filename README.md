...
+ Создание справки
+ Возможность редактировать настройки из консоли
+ Возможность печать текста статьи в консоль
### Работа утилиты
+ Обработка ошибок HTTP запросов
+ Возможность настраивать место сохранения файлов с текстом статей
+ Возможность выбирать форматов сохранения и разметок текста